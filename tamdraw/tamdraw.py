...
def draw_hrz_field(field,
                   ...
                   var_label="",title="",
                   cmap="RdBu_r"|str |mpl.colors.Colormap,
...
def axplot_hrz_field(ax,field,
                   ...
                   xtickint=20,ytickint=10,
                   var_label="",title="",
                   cmap="RdBu_r"|str |mpl.colors.Colormap,add_colorbar=False,cout=True,
...
def axplot_hrz_field_double(ax,field1, field2,
                   ...
                   xtickint=20,ytickint=10,
                   var_label="",title="",
                   cmap="RdBu_r"|str |mpl.colors.Colormap,add_colorbar=False,cout=True,ccontour='black',
